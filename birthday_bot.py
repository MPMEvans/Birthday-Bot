...
async def commands(message):
    ...
    await message.channel.send(f'Hello <@{username}>, you can add your own birthday by typing !add, and check who has the next birthday by typing !next. Hope this helps! :slight_smile:')
